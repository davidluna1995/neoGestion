        ...
        <b-card class="text-center tituloTabla transparencia">
          ...
          <div>
            ...
            >
              ...
              <template v-slot:cell(stock)="data">{{formatPrice(data.item.cantidad)}}</template>
...
<style src="../administrarProducto/administrarProducto.css"></style>
