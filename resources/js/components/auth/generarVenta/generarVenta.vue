                ...
                <div class="row">
                  <div class="col-12">
                    <b-input-group>
                      <b-form-input
                        size="sm"
                        placeholder="Buscar producto o escanee el codigo de barra"
                    ...
                    <div>
                      ...
                      >
                        <template v-slot:cell(cantidad)="data">
                          <b-input block type="number" pill size="sm" :value="data.item.cantidad"></b-input>
                        </template>
                        <template v-slot:cell(detalle)="data">{{ data.item.detalle }}</template>
                        <template v-slot:cell(precioProd)="data">{{ data.item.precioProd }}</template>
                        <template v-slot:cell(subTotal)="data">
                          <b-input>{{ data.item.subTotal }}</b-input>
                        </template>
                        <template v-slot:cell(opc)>
                          <div class="col-12 col-xl-12">
                            <b-button size="sm" pill variant="danger">x</b-button>
                          </div>
                        </template>
                      </b-table>
                    </div>
              ...
              <b-card>
                ...
                <div v-if="formaPago == '1' || formaPago == '1,2' || formaPago =='2,1'">
                  <b-form-group label="Monto en CLP">
                    <b-input-group>
                      <b-form-input size="sm" placeholder="Ingrese Monto" v-model="montoEfectivo"></b-form-input>
                      <b-input-group-append>
                ...
                <div v-if="formaPago == '2' || formaPago == '1,2' || formaPago =='2,1'">
                  <b-form-group label="Monto en CLP">
                    <b-input-group>
                      <b-form-input size="sm" placeholder="Ingrese Monto" v-model="montoDebito"></b-form-input>
                      <b-input-group-append>
                ...
                <div v-if="formaPago == '3'">
                  <b-form-group label="Monto en CLP">
                    <b-input-group>
                      <b-form-input size="sm" placeholder="Ingrese Monto" v-model="montoCredito"></b-form-input>
                      <b-input-group-append>
